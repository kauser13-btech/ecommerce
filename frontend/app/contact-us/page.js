            ...
            <div className="bg-gray-50 min-h-screen pt-36 pb-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid lg:grid-cols-3 gap-8 lg:gap-12">
                        ...
                        {/* Contact Info & Map - Takes up 1 column on large screens */}
                            ...
                            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                                ...
                                <div className="mt-8 pt-8 border-t border-gray-100">
                                    ...
                                    <div className="flex gap-4">
                                        <a href="https://www.facebook.com/appleians" target="_blank" className="w-10 h-10 bg-gray-50 rounded-full flex items-center justify-center text-blue-600 hover:bg-blue-600 hover:text-white transition-all duration-300">
                                            <Facebook size={20} />
                                        </a>
                                        <a href="https://www.instagram.com/appleiansbd" target="_blank" className="w-10 h-10 bg-gray-50 rounded-full flex items-center justify-center text-pink-600 hover:bg-pink-600 hover:text-white transition-all duration-300">
                                            <Instagram size={20} />
                                        </a>
                                        <a href="https://tiktok.com/@appleians" target="_blank" className="w-10 h-10 bg-gray-50 rounded-full flex items-center justify-center text-black hover:bg-black hover:text-white transition-all duration-300">
                        ...
                        <div className="lg:col-span-2 space-y-8">
                            ...
                            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 lg:p-10 relative overflow-hidden">
                                {/* Decorative blob */}
